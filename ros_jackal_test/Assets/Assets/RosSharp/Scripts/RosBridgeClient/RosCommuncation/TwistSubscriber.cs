...
namespace RosSharp.RosBridgeClient
{
    public class TwistSubscriber : UnitySubscriber<MessageTypes.Geometry.Twist>
    {
        ...
        private void ProcessMessage()
        {
            ...
            SubscribedTransform.Rotate(Vector3.forward, angularVelocity.x);
            SubscribedTransform.Rotate(Vector3.up, angularVelocity.y);
            SubscribedTransform.Rotate(Vector3.left, angularVelocity.z);
